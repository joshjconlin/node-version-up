...
module.exports = {
    ...
    conditional(comparatorFunc, conditionalFunc) {
        return (value) => new Promise((resolve => {
            return comparatorFunc() ? resolve(conditionalFunc(value)) : resolve(value);
        }));
    },

    passFuncWithArgs(args = [], func = noOp()) {
      return (value) => func(...args, value)
    },

    chain(args, func) {
        return new Promise((resolve) => {
            return resolve((value) => new Promise(((resolve1, reject1) => {
